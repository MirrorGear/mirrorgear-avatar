Shader "Custom/ToonStyle01"
{
	Properties
	{
		...
		_RampSmooth ("Ramp Smoothing", Range(0.001,2)) = 0.1
		//[Header(Other Lights)]
	...
	SubShader
	{
		...
		#pragma surface surf ToonColorsCustom addshadow fullforwardshadows exclude_path:deferred exclude_path:prepass
		#pragma target 3.0
		...
		inline half4 LightingToonColorsCustom (inout SurfaceOutputCustom s, half3 viewDir, UnityGI gi)
		{
		...
		void LightingToonColorsCustom_GI(inout SurfaceOutputCustom s, UnityGIInput data, inout UnityGI gi)
		{
